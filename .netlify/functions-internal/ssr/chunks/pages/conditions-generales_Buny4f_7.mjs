import { e as createAstro, f as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead, k as renderSlot, u as unescapeHTML } from '../astro_DUL18hxm.mjs';
...
const $$ConditionLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": frontmatter.title }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container mx-auto max-w-prose space-y-8 py-20 text-justify md:py-40"> <h1 class="my-10 text-center text-4xl font-semibold md:text-5xl">
Conditions Générales de la communauté
</h1> ${renderSlot($$result2, $$slots["default"])} </div> ` })}`;
