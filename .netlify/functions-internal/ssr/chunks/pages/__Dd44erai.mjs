import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as renderSlot, l as UnknownContentCollectionError, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, u as unescapeHTML } from '../astro_DUL18hxm.mjs';
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, p as prependForwardSlash } from '../astro/assets-service_CDsru9zS.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CDsru9zS.mjs'
    ).then(n => n.s).catch((e) => {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/possacode-devday-2024.md": () => import('../possacode-devday-2024_B5i1kE88.mjs')});
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"possacode-devday-2024":"/src/content/blog/possacode-devday-2024.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/possacode-devday-2024.md": () => import('../possacode-devday-2024_BELsJME8.mjs')});
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": post.data.title, "description": post.data.description }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container py-40"> ${renderComponent($$result2, "Image", $$Image, { "src": post.data.hero_image, "alt": post.data.title, "format": "webp", "quality": "high", "loading": "eager" })} <h2 class="text-healding-2 font-semibold uppercase">${post.data.title}</h2> <p>${post.data.description}</p> ${renderComponent($$result2, "Content", Content, {})} </div> ` })}`;
...
export { $$BaseLayout as $, ____slug_ as _, $$Image as a, $$Button as b, getCollection as c, getConfiguredImageService as g, imageConfig as i };
